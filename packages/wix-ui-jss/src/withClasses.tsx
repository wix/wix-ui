...
export function withClasses<P extends { ref?: string }>(
  CoreComponent: React.ComponentType<P & HasClasses>,
  styles: Function,
): React.ComponentClass<P & ThemedComponentProps> {
  ...
  > {
    ...
    componentWillReceiveProps(nextProps) {
      if (this.props.theme !== nextProps.theme) {
        this.setState({
          classes: generateClasses(styles(nextProps.theme), this.id),
        });
      }
    }
    ...
    render() {
      const coreProps = Object.assign({}, this.props, { theme: undefined });
  ...
  return isStatelessComponent(CoreComponent)
    ? ThemedComponent
    : hoistNonReactMethods(ThemedComponent, CoreComponent, {
