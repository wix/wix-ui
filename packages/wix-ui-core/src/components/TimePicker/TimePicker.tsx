...
class TimePicker extends React.Component<TimePickerProps, TimePickerState> {
  ...
  static propTypes = {
    ...
    /** When true, does not tie hour to minute when incrementin / decrementing (i.e, inc on 00:59 will go to 00:00 instead of 01:00) */
    separateSteps: bool,
  ...
  render() {
    const {classes, useNativeInteraction, useAmPm, ...rest} = this.props;
...
export default createHOC(TimePicker);
