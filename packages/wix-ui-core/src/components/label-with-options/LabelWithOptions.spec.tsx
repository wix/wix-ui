...
describe('LabelWithOptions', () => {
  ...
  describe('when disabled', () => {
    ...
    beforeEach(() => {
      driver = createDriver(
        createLabelWithOptions({ options, disabled: true }),
      );
    });
  ...
  describe('when selecting options', () => {
    ...
    it('should call onSelect', () => {
      ...
      const driver = createDriver(
        createLabelWithOptions({ options, onSelect }),
      );
      driver.click();
      driver.optionAt(0).click();
    ...
    it('allows picking only one option when multi prop is false', () => {
      const driver = createDriver(
        <LabelWithOptions options={generateOptions()} multi={false} />,
      );
      driver.click();
      driver.optionAt(0).click();
      driver.click();
  ...
  describe('checkbox', () => {
    it('displays a checkbox when given the prop', () => {
      const driver = createDriver(
        <LabelWithOptions checkbox options={generateOptions()} />,
      );
    ...
    it('marks the checkbox as checked when an option is selected', () => {
      const driver = createDriver(
        <LabelWithOptions checkbox multi options={generateOptions()} />,
      );
  ...
  describe('testkit', () => {
    it('should exist', () => {
      expect(
        isTestkitExists(
          <LabelWithOptions options={[]} />,
          labelWithOptionsTestkitFactory,
        ),
      ).toBe(true);
    });
  });
    ...
    it('should exist', () => {
      expect(
        isEnzymeTestkitExists(
          <LabelWithOptions options={[]} />,
          enzymeLabelWithOptionsTestkitFactory,
          mount,
        ),
      ).toBe(true);
    });
