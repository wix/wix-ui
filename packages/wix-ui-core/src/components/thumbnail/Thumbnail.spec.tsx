...
describe('Thumbnail', () => {
  ...
  describe('selectedIcon prop', () => {
    ...
    it('should display icon when selected', () => {
      const driver = createDriver(
        <Thumbnail selected selectedIcon="✅">
          <div />
        </Thumbnail>,
      );
    ...
    it('should render the given icon when selected', () => {
      const driver = createDriver(
        <Thumbnail selected selectedIcon={<div>hey</div>}>
          <div />
        </Thumbnail>,
      );
      expect(driver.getSelectedIcon().outerHTML).toBe(
        mount(<div>hey</div>).html(),
      );
    });
  });
