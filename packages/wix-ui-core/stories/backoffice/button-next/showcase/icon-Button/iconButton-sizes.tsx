...
const description = (
  <div>
    IconButton supports four main sizes: <code>{iconButtonSizes.tiny.size}</code>, <code>{iconButtonSizes.small.size}</code>, <code>{iconButtonSizes.medium.size}</code>, and <code>{iconButtonSizes.large.size}</code> sizes.
    Default size is <code>{iconButtonSizes.medium.size}</code>
  </div>
);
